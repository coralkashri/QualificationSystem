...
router.get("/", con_validator.require_login, plans_controller.get_plans);

router.get("/p:plan_name", con_validator.require_login, plans_controller.get_plan);

router.post("/create/:plan_name", con_validator.require_login, (req, res, next) => { // Create plan
...
router.post("/modify/:plan_name", con_validator.require_login, (req, res, next) => { // Modify plan
...
router.post("/remove/:plan_name", con_validator.require_login, (req, res, next) => { // Delete plan
